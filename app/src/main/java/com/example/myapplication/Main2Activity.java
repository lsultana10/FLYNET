...
public class Main2Activity extends NavigationActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference= FirebaseDatabase.getInstance().getReference("Matches").child(fAuth.getCurrentUser().getUid());
        ...
        reference.child("list").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                /*if(match.getImage().equals("default")){
                    ...
                    Glide.with(Main2Activity.this).load(match.getImage()).into(profile_image);
        ...
        viewPagerAdapter.addFragments(new UserFragment(),"Matches");
